...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side">
        <ul class="layui-nav layui-nav-tree" lay-filter="test">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    ...
                    <dd><a href="${pageContext.request.contextPath }/toUpdateAdminPwdPage" target="iframe">管理员密码更改</a>
                    </dd>
                </dl>
            </li>
        </ul>
        ...
        <ul class="layui-nav layui-nav-tree" lay-filter="test">
            <li class="layui-nav-item">
                <a href="javascript:;">留言信息管理</a>
                <dl class="layui-nav-child">
                    <dd><a href="${pageContext.request.contextPath }/toAllLiuyanPage" target="iframe">所有留言信息</a></dd>
                </dl>
            </li>
        </ul>
    </div>
    <div class="layui-body">
        <iframe src="${pageContext.request.contextPath }/welcome" width="100%" height="100%" frameborder="0"
